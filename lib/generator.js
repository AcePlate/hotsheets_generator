...
module.exports = class CodotypeGenerator {
  ...
  async composeWith (generatorModule, options={}) {
    ...
    if (generatorModule.relative_path) {
      ...
      // TODO - document
      modulePath = path.join(base, generatorModule.relative_path)

    // Handle absolute path
    } else if (generatorModule.absolute_path) {

      modulePath = path.join(generatorModule.absolute_path)

    // Handle module path
    } else if (generatorModule.module_path) {

      modulePath = generatorModule.module_path + '/generator'
    }
